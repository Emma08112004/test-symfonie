...
class EtudiantController extends AbstractController
{
    ...
    public function indexEtudiant(EtudiantRepository $etudiantRepository): Response
    {
    ...
    #[Route('/filtre',name: 'app_etudiant_filtre', methods: [ 'GET','POST'])]
    public function filtre(EtudiantRepository $etudiant, Request $request): Response
    {
        return $this->render('etudiant/filtre.html.twig', [
            'etudiants' => $etudiant->findBy(
                [
...
//$sexeTab = [0 => "Non Binaire", 1 => "Femme", 2 => "Homme"];
//return $this->render(view:'etudiant/filtre.html.twig',)
